...
const Toast = ({ message, resp, sound }) => {
  ...
  return (
    <>
      {show && (
        <div className="messageOutcome absolute transition-all duration-200 top-4 right-0 p-2">
          <div
            className="flex items-center w-64 max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
            role="alert"
          >
            <div
              className={`${
                resp && message === "Successful!" || "Copied"
